...

{
 ...
 int32 status, iret;
 char ddate[5], type[2], hdfname[MAXLEN], outfile[MAXLEN], 
       contkey[2];
     ...
     if (deslen != (int32) -1) 
      {
       ...
       {
          printf("ERROR - couln not read file descriptor 5 - continuing processing\n");
...

{
 ...
 int32 k=0,i,j,iendvl1,iendvl2,index;
 uint8 * c;
 uint8 param_6,lat,lon;
 float32 param_116,param_23,HGT,TS,TC,param_120,param_125;
 float32 PSURF,PTROP;
 int32 LYRTRP,ii,LYSRF;
